...
two evens highlight the complexity of these smoke events, which are
...
each node. The relative importance of each variable can calculated as
blah blah be visualized through a

\begin{itemize}
\tightlist
\item
  application for health studies \#\# Advantages over existing methods
  \#\# Limitations
\end{itemize}
